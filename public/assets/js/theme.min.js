...
!(function (e) {
    ...
    (function () {
        ...
        "undefined" != typeof Chart &&
            ...
            (Chart.defaults.global.tooltips.custom = function (n) {
                ...
                if (
                    (e || ((e = document.createElement("div")).setAttribute("id", "chart-tooltip"), e.setAttribute("role", "tooltip"), e.classList.add("popover"), e.classList.add("bs-popover-top"), document.body.appendChild(e)),
                    0 !== n.opacity)
                ) {
                    if (n.body) {
                        var t = n.title || [],
                ...
                return (
                    1 <
                        t.datasets.filter(function (e) {
                            return !e.hidden;
                        }).length && (a = '<span class="popover-body-label mr-auto">' + n + "</span>"),
            ...
            Chart.scaleService.updateScaleDefaults("linear", {
                gridLines: { borderDash: [2], borderDashOffset: [2], color: e[300], drawBorder: !1, drawTicks: !1, zeroLineColor: e[300], zeroLineBorderDash: [2], zeroLineBorderDashOffset: [2] },
                ticks: { beginAtZero: !0, padding: 10, stepSize: 10 },
            }),
            Chart.scaleService.updateScaleDefaults("category", { gridLines: { drawBorder: !1, drawOnChartArea: !1, drawTicks: !1 }, ticks: { padding: 20 } }),
            n &&
                    ...
                    e.addEventListener(t, function () {
                        !(function (e) {
                            ...
                            if ("toggle" === a) {
                                ...
                                if (!c) {
                                    for (var s in ((c = {}), r)) "_meta" !== s && (c[s] = r[s]);
                                    (c.order = 1e3), (c.hidden = !0), n.push(c);
                                }
                                var i = n[o] === r ? c : n[o];
                                for (var s in r) "_meta" !== s && (r[s] = i[s]);
                                l.update();
                            }
                            if ("add" === a) {
    ...
    (function () {
        ...
        [].forEach.call(e, function (t) {
            ...
            e &&
                e.addEventListener(a[0], function (e) {
                    !(function (e, t) {
            ...
            $(e).on("hide.bs.dropdown", function () {
                var e;
                (e = this.querySelector(".dropdown-menu").querySelectorAll(".dropdown-menu")) &&
                    [].forEach.call(e, function (e) {
    ...
    (function () {
        ...
        "undefined" != typeof Draggable && e && new Draggable.Sortable(e, { draggable: ".kanban-item", mirror: { constrainDimensions: !0 } }),
            t &&
    ...
    (function () {
        ...
        "undefined" != typeof List &&
            e &&
            [].forEach.call(e, function (e) {
                var t, a, o, l, n, r, c, s, i, d, u, f;
                (a = (t = e).querySelector(".list-alert")),
                    (o = t.querySelector(".list-alert-count")),
                    (l = t.querySelector(".list-alert .close")),
                    (n = t.querySelectorAll(".list-checkbox")),
                    (r = t.querySelector(".list-checkbox-all")),
                    (c = t.querySelectorAll(".list-pagination")),
                    (s = t.querySelector(".list-pagination-prev")),
                    (i = t.querySelector(".list-pagination-next")),
                    (d = t.dataset.list && JSON.parse(t.dataset.list)),
                    (u = Object.assign({ listClass: "list", searchClass: "list-search", sortClass: "list-sort" }, d)),
                    (f = new List(t, u)),
                    c &&
    ...
    (function () {
        ...
        [].forEach.call(e, function (a) {
            a.addEventListener("click", function () {
                var t, e;
                (e = (t = a).closest(".collapse").querySelectorAll(".collapse")),
                    [].forEach.call(e, function (e) {
                        e !== t && $(e).collapse("hide");
                    });
            });
    ...
    (function () {
        ...
        jQuery().select2 &&
            ...
            [].forEach.call(e, function (e) {
                var t, a, o, l;
                (a = (t = e).dataset.options ? JSON.parse(t.dataset.options) : {}),
                    (o = {
    ...
    (function () {
        ...
        "undefined" != typeof Draggable && e && new Draggable.Sortable(e, { draggable: ".checklist-control", handle: ".custom-control-caption", mirror: { constrainDimensions: !0 } });
    })(),
    (function () {
