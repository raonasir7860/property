       ...
       <div class="container">
              <div class="card">
                <div class="card-body">
                  ...
                  <!-- Form -->
                  <form action="{{ url('dashboard/store-agent') }}"method="post"enctype="multipart/form-data">
                    {{csrf_field()}}
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" id="exampleInputEmail1" placeholder="Enter Phone Number"name="phone_number">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Card Number"name="card_number">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Enter Area" name="area">
                      @if ($errors->has('area'))  
                    ...
                    <input type="file" name="image" class="form-control form-control-lg" id="formFileLg"  />
                     ...
                     <div align="center" >
                    <button type="submit" class="btn btn-primary"style="margin-top: 10px;">Create Agent</button></div>
                  </form>
