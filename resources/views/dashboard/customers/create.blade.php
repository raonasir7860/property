       ...
       <div class="container">
              <div class="card">
                <div class="card-body">
                  ...
                  <!-- Form -->
                  <form action="{{ url('dashboard/store-customer') }}"method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
                    ...
                    <!-- Button -->
                    <div align="center" >
                    <button type="submit" class="btn btn-primary"style="margin-top: 10px;">Create Customer</button></div>
                  </form>
